# -*- coding: utf-8 -*-
"""
Created on Wed Dec 16 21:16:55 2015
...
today930am = todayNow.replace(hour=9, minute=30, second=0, microsecond=0)
...
class SimpleQuantEventEngine:
    ...
    def __onTimer(self):
        ...
        # 向队列中存入计时器事件
        #only at trading time
        now = datetime.datetime.now()
        if(now > today930am and now < today1130am) or (now > today1pm and now < today3pm):
            self.put(event)    
